...
|:---:|:---:|:---:|:---:|:---:|
| NYC Yellow Taxi trips (2019, 12 monthly files) | NYC TLC [Azure Open Datasets](https://learn.microsoft.com/en-gb/azure/open-datasets/dataset-taxi-yellow) · [Kaggle](https://www.kaggle.com/datasets/microize/newyork-yellow-taxi-trip-data-2020-2019)| ~84M rows / 12.42 GB after cleaning |  (unioned 12 month data in Tableu Prep)| [./Assessment-3/nyctlc_stratified_sampling.ipynb](Assessment-3-Project-Implementation/nyctlc_stratified_sampling.ipynb) |
| Stratified sample | derived | ~5.05M rows · 242/263 zones · 1.5M held-out for validation | (generated by Python/Pandas/Numpy in Jupyter notebook) |[./Assessment-3/nyctlc_stratified_sampling.ipynb](Assessment-3-Project-Implementation/nyctlc_stratified_sampling.ipynb) |
